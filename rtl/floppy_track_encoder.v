/* 
 ...
 ★ PORTED VERBATIM from MacPlus_MiSTer rtl/floppy_track_encoder.v at b340c9f
 (its PR #22, "Erase Disk"), which is hardware-proven on a Plus. Do NOT
 "improve" the five-bytes-behind-the-D5 arithmetic; without the relay a
 guest format fails with fmt1Err, because a free-running read side presents
 whatever sector the head happens to be over rather than the sector 0 the
 ROM requires to see first. See docs/floppy_write_plan.md Phase 6A.
